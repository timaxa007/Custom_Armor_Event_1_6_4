...
public class TestArmorObjMOD {
	...
	@SidedProxy(modId = MODID, serverSide = "timaxa007.test_armor_obj.ProxyServer", clientSide = "timaxa007.test_armor_obj.client.ProxyClient")
	...
	public void preInit(cpw.mods.fml.common.event.FMLPreInitializationEvent event) {
		...
		item_armor_test_obj_helm_id = main.getItem("item_armor_test_obj_helm_id", id++).getInt();
		item_armor_test_obj_vest_id = main.getItem("item_armor_test_obj_vest_id", id++).getInt();
		item_armor_test_obj_pants_id = main.getItem("item_armor_test_obj_pants_id", id++).getInt();
		item_armor_test_obj_boots_id = main.getItem("item_armor_test_obj_boots_id", id++).getInt();
